...
%\qsong{Remember to put the figure into Annexe part. Here I wan to show that, the difference between approximation formula and exact integral is smaller when normalized load increase }.
...
%TODO:....
%x\qsong{To be more restrict, we should explain why we can remove the subscript $y_i$ in the following formula}:
\begin{align}
...
%TODO:
%\qsong{This paragraph should be simplified. Since in another Chapter, the same numerical technique should have been presented...}
